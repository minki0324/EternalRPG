...
public class GameManager : MonoBehaviour
{
    ...
    public string CurrentMapName = "깊은 숲";
    ...
    public void RenewStat()
    {
        ...
        int runePercent = RuneHashSet.Contains("만능의 룬") ? 20 : 0;
    ...
    { // 공격력 -> (기본 공격력 + 장비로 인한 깡뎀) * 각종 퍼센트 합산
        ...
        int runePercent = RuneHashSet.Contains("균형의 룬") ? 20 : 0;
    ...
    public void RenewHP()
    {
        ...
        int runePercent = RuneHashSet.Contains("균형의 룬") ? 50 : 0;
    ...
    public void RenewCritical()
    {
        ...
        int runeCriPercent = RuneHashSet.Contains("치명의 룬") ? 30 : 0;
        float runeCriDamage = RuneHashSet.Contains("치명의 룬") ? 0.3f : 0;
        if (ArmorData != null)
        {
    ...
    public void RenewCombo()
    {
        ...
        int runeComboPercent = RuneHashSet.Contains("속공의 룬") ? 40 : 0;
    ...
    public void RenewAvoid()
    {
        ...
        int runeAvoidPercent = RuneHashSet.Contains("신속의 룬") ? 30 : 0;
    ...
    public void RenewReward()
    {
        ...
        runeEXP += RuneHashSet.Contains("통달의 룬") ? 100 : 0;

        // 골드
        int runeGold = RuneHashSet.Contains("부유의 룬") ? 40 : 0;
        runeGold += RuneHashSet.Contains("부귀의 룬") ? 70 : 0;

        // 드랍율
        int runeDropRate = RuneHashSet.Contains("탐색의 룬") ? 30 : 0;
        runeDropRate += RuneHashSet.Contains("갈취의 룬") ? 70 : 0;
    ...
    private void RenewOther()
    {
        // 보너스 AP
        int sumBonusAP = 0;
        int runeBonusAP = RuneHashSet.Contains("마나의 룬") ? 1 : 0;
        runeBonusAP += RuneHashSet.Contains("마력의 룬") ? 1 : 0;
        runeBonusAP += RuneHashSet.Contains("신비의 룬") ? 2 : 0;

        // 이동속도
        float sumMoveSpeed = 0;
        float runeMoveSpeed = RuneHashSet.Contains("속도의 룬") ? 10f : 0f;
        runeMoveSpeed += RuneHashSet.Contains("태풍의 룬") ? 15f : 0f;
        ...
        basicRuneBuff += RuneHashSet.Contains("고대의 룬") ? 0.5f : 0f;
        basicRuneBuff += RuneHashSet.Contains("풍요의 룬") ? 0.5f : 0f;
    ...
    public void ResetRound()
    {
        ...
        runeBonusEnergy += RuneHashSet.Contains("체력의 룬") ? 4 : 0;
        runeBonusEnergy += RuneHashSet.Contains("무한의 룬") ? 7 : 0;
